    ...
    <div className="container mx-auto px-[5%] lg:pl-[9%]">
      <div className="mt-4  text-white text-start lg:w-1/2 md:w-[70%] w-[80%] ">
        ...
        <div className="flex flex-col sm:flex-row md:mt-20 lg:mt-10 items-center">
          <button className="bg-[#7828d6] text-black px-6 py-2 rounded-full min-w-[150px] min-h-[40px] flex items-center text-white justify-center mb-4 sm:mb-0 button-hover font-semibold">
            Explore More
          </button>
