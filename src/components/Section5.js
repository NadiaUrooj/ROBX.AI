...
const Section5 = () => {
  return (
    <div className="container py-16 border-t-2 border-gray-600">
      <div className="flex flex-col lg:flex-row justify-between text-white mt-5 mx-8">
        <div className="w-full lg:w-1/2 text-left">
          ...
          <div className="space-y-4 mb-8 flex flex-wrap lg:flex-nowrap">
            <div className="flex items-center space-x-2 ">
              <img src={Icon1} alt="Icon1" className="h-8 w-8" />
            ...
            <div className="flex items-center space-x-2">
              <img src={Icon2} alt="Icon2" className="h-8 w-8" />
              <div className="flex flex-col items-start">
                <p className="text-xl font-bold">
                  44{" "}
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-400">
                ...
                <p className="text-xs">Worldwide User</p>
              </div>
              <div className="border-l-2 border-gray-400 h-14 pl-4"></div>
            </div>
            <div className="flex items-center space-x-2">
              <img src={Icon3} alt="Icon3" className="h-8 w-8" />
              <div className="flex flex-col items-start">
                <p className="text-xl font-bold">
                  5{" "}
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-400">
          ...
          <button className="bg-purple-600 text-white px-8 py-2 font-semibold rounded-full">
            Learn More
          </button>
        </div>
